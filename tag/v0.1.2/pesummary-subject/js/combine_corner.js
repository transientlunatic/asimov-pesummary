...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['fake-pe-3'] = ['luminosity_distance', 'dec', 'a_2', 'a_1', 'geocent_time', 'phi_jl', 'psi', 'ra', 'mass_2', 'mass_1', 'phi_12', 'tilt_2', 'theta_jn', 'tilt_1', 'chi_p', 'chirp_mass', 'mass_ratio', 'symmetric_mass_ratio', 'total_mass', 'chi_eff', 'redshift', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'log_likelihood'];
    ...
    var data = {}
    data['fake-pe-3'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
